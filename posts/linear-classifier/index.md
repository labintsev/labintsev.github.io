...
- [Параметризованное сопоставление изображений с оценками меток](#параметризованное-сопоставление-изображений-с-оценками-меток)
- [Интерпретация линейного классификатора](#интерпретация-линейного-классификатора)
- [Функция потерь](#функция-потерь)
- [Потеря машины мультиклассового опорного вектора](#потеря-машины-мультиклассового-опорного-вектора)
- [Практические соображения](#практические-соображения)
- [Классификатор Softmax](#классификатор-softmax)
- [SVM против Softmax](#svm-против-softmax)
- [Интерактивная веб-демонстрация](#интерактивная-веб-демонстрация)
